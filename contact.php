...
<?php include 'header.php'?>
		...
		<div class="hero-area section">
			...
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bgc2b.jpg); " ></div>
		...
		<div id="contact" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="contact-form form-cardlayout">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="footer-logo">
							<a class="logo" style="font-size: 30px;" href="main.html">Predictly</a>
						</div>
					</div>
