...
<html lang="en">
	...
	<?php include 'header.php'?>
		...
		<div class="hero-area section">
			...
			<div class="bg-image bg-parallax overlay course-img1" style="background-image:url(./img/bgc2-neha.jpg); " ></div>
				...
				<div id="courses-wrapper" >
					...
					<div class="row" >
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course wow animate__fadeInRight">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course wow animate__fadeInRight wow animate__fadeInRight">
								<a href="https://www.w3schools.com/bootstrap4/default.asp" class="course-img" target="_blank">
