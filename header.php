<head>
	...
	<body>
		...
		<!--Header-->
        <header id="header" class="transparent-nav" style="position: fixed;background-color: #1C364A; top: 0;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php">Predictly</a>
					</div>
					<!-- /Logo -->
				...
				<!-- Navigation -->
				<nav id="nav" class="wow slideInDown">
				...
				<?php else: ?>
					<!-- Navigation -->
				<nav id="nav" class="wow fadeInLeft">
					<ul class="main-menu nav navbar-nav navbar-right">
						<li><a href="main.php">Home</a></li>
                        <li class="dropdown">
